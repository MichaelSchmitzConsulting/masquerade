...
public class MasterDetailView extends CustomComponent {
	...
	public MasterDetailView(FormFieldFactory fieldFactory) {
		this(fieldFactory, false);
	}
	
	public MasterDetailView(FormFieldFactory fieldFactory, boolean showUpDownButtons) {
		this(fieldFactory, showUpDownButtons, null);
	}
	/**
	 ...
	 * visual editor.
	 */
	public MasterDetailView(FormFieldFactory fieldFactory, boolean showUpDownButtons, ValueChangeListener selectionListener) {
		this.isUpDownButtons = showUpDownButtons;
		
		if (selectionListener == null) {
			selectionListener = new ValueChangeListener() {
				@Override
		...
		buildMainLayout(selectionListener);
	...
	private void buildMainLayout(ValueChangeListener selectionListener) {
	    // Create layout
        ...
        masterTable.setMultiSelect(false);
        ...
        masterTable.addListener(selectionListener);
	...
	private Component createForm(Object bean) {
		...
		form.setSizeFull();
		final String shortTypeName = bean.getClass().getSimpleName();
	...
	public void refreshViewFromDataSource() {
		Container container = getDataSource();
		setDataSource(container);
	}

	public Object getSelection() {
		return masterTable.getValue();
	}

	public void setDetailEditorBean(Object bean) {
		updateDetailView(bean);
	}
}
